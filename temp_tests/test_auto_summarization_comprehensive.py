    ...
    def test_unlimited_conversation_turns_simulation(self):
        ...
        for turn in range(1, 101):
            ...
            if turn % 20 == 0:
                ...
                # Should never exceed 11 messages (1 summary + 10 recent)
...
def run_comprehensive_tests():
    """Run the comprehensive auto-summarization test suite."""
    print("=" * 80)
    print("🚀 Running Comprehensive Auto-Summarization Integration Tests")
    print("=" * 80)
    
    # Create test suite
    suite = unittest.TestLoader().loadTestsFromTestCase(TestAutoSummarizationComprehensive)
    ...
    print(f"\n✅ Tests Passed: {tests_passed}/{result.testsRun}")
    ...
    print("\n" + "=" * 80)
    if success_rate == 100:
        print("🎉 All tests passed! Auto-summarization system is working perfectly!")
        print("✅ Database verification: PASSED")
        print("✅ Multi-cycle summarization: PASSED")
        print("✅ Unlimited conversation support: VERIFIED")
    elif success_rate >= 80:
        print("⚠️  Most tests passed, but some issues need attention")
    else:
        print("🚨 Critical issues found - auto-summarization needs fixes")
