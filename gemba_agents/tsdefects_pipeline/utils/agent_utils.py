"""
Utility functions for loading and invoking agents within the TsDefects pipeline.

This module combines functionality from both defect_analysis and pilger_processing
agent utilities to support the integrated pipeline.
"""
...
async def load_and_build_agent(
...
) -> Tuple[CompiledStateGraph, Optional[Any], Any]:
    """
    ...
    Returns:
        Tuple of (compiled_agent, mcp_client, direct_logger)
